  ...
  public void run() {
    ...
    while (!Lab5.localized) {
      updateStart = System.currentTimeMillis();
		...
		distL = (Math.PI*WHEEL_RAD*(leftMotorTachoCount-lastTachoL)/180); // compute wheel displacements
		...
		double thetaDeg = (((deltaT*180/Math.PI)));//rad to deg
